...
CRATE_DIR="$SCRIPT_DIR/../lumen-pdf-core"
OUT_DIR="$SCRIPT_DIR/../LumenPDF/Generated"
...
DYLIB_PATH="$TARGET_DIR/$TARGET/debug/liblumen_pdf_core.dylib"
...
install_name_tool -id "@rpath/liblumen_pdf_core.dylib" "$OUT_DIR/liblumen_pdf_core.dylib"

echo "✓ 完成。产物位于 LumenPDF/Generated/"
